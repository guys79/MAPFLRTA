...
public class TestPreformer {
    ...
    private long budgetUsed; //The amount of used budget
     ...
     */
    public void updatePerSearch(double numberOfUpdates,long searchTime,double sumOfCosts, double makeSpan,int iteration,boolean complete,double averageTimePerIteration,long budgetUsed)
    {

        this.rawResults.add(new ExperimentData(numberOfUpdates,searchTime,sumOfCosts,makeSpan,iteration,complete,averageTimePerIteration,(budgetUsed*1.0)/iteration));
    ...
    public void printInfo(String textPath,String rawPath )
    {
        ...
        message+="Average budgetUsed per iteration "+((this.budgetUsed*1.0)/(this.iteration))+"\n";
