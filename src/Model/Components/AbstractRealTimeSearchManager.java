...
public abstract class AbstractRealTimeSearchManager implements IRealTimeSearchManager {
    ...
    private long budgetUsed;//The average time of iteration
    /**
    ...
    public AbstractRealTimeSearchManager(Problem problem)
    {
        ...
        this.budgetUsed = Long.MAX_VALUE;
    ...
    public void calculatePrefixAndBudget()
    {
      ...
      /*  for(Map.Entry<Agent,Integer> entry :budgetMap.entrySet())
        {
            System.out.println("Agent "+entry.getKey().getId() +" "+entry.getValue());
        }*/
        calculatePrefix();
    }
