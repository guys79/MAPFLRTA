...
public class ExperimentData {
    ...
    private double budgetUsed;//The amount of used budget
     ...
     */
    public ExperimentData(double numberOfUpdates,long searchTime,double sumOfCosts, double makeSpan,int iteration,boolean complete,double averageTimePerIteration,double budgetUsed)
    {
