...
public class Model {
    ...
    public void next() {
        ...
        if (problem != null) {
            ...
            TestPreformer.getInstance().updatePerSearch(Node.average,time,sumOfCosts,maxSpan,((AbstractRealTimeSearchManager)realTimeSearchManager).getIteration(),((AbstractRealTimeSearchManager)realTimeSearchManager).isSuccess(),((AbstractRealTimeSearchManager)realTimeSearchManager).getIterationAvergae(),((AbstractRealTimeSearchManager)realTimeSearchManager).getBudgetUsed());
            System.out.println();
            controller.draw();
